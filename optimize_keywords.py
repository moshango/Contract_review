...
"""
规则关键词优化脚本
用于分析和优化 rules.xlsx 中的关键词配置，提高匹配命中率
"""
...
class RulesOptimizer:
    ...
    OPTIMIZATION_RULES = {
        ...
        # 保密相关
        '保密条款': '保密;秘密;机密;隐私;保护;保密期;保密条款;保密信息;秘密信息;机密信息;泄露;披露',
    ...
    def analyze_rules(self):
        ...
        if rules_to_optimize:
            ...
            for item in rules_to_optimize:
                ...
                print(f"   效果: {old_count} 个关键词 → {new_count} 个关键词 (+{improvement})")
    ...
    def generate_report(self, optimized_count):
        """生成优化报告"""
        print("\n" + "=" * 80)
        print("📋 优化建议报告")
        print("=" * 80)
...
def main():
    ...
    # 定位 rules.xlsx
    filepath = r"src/main/resources/review-rules/rules.xlsx"
    ...
    # 应用优化
    optimized_count = optimizer.apply_optimization()
    ...
    # 生成报告
    optimizer.generate_report(optimized_count)
